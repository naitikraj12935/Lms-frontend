...
export default function HomePage() {
  return (
    <HomeLayout>
      <div className="pt-48 mb-4 text-white flex items-center justify-center gap-10">
        ...
        <div className="w-1/2 space-y-6">
            ...
            <div className="space-x-6">
             <Link to="/courses">
              <button className="px-4 py-4 text-xl bg-yellow-500 text-blue-500 rounded-xl hover:bg-yellow-800 hover:text-white hover:scale-90 transition-all ease-in-out duration-200">
                Explore Courses
              </button>
              </Link>
              <Link to="/contact">
